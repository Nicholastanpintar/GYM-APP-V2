...
export const EX={
uc:mk([["Incline BB Bench","r",.25,.45,.70,.90,1.05,1.20,1.35,1.55],["Incline DB Press","a",8,16,26,34,40,46,52,62],["Incline DB Fly","a",5,10,18,24,28,32,36,44],["Low-High Cable Fly","a",4,8,16,22,26,30,36,44],["Incline Machine Press","a",12,25,45,60,72,82,92,110],["Incline Smith Press","r",.20,.40,.62,.80,.92,1.05,1.20,1.40],["Landmine Press","a",8,16,28,36,42,48,55,66],["Rev Grip Bench","r",.20,.40,.62,.80,.92,1.05,1.18,1.38],["Incline Cable Press","a",5,10,18,26,32,38,44,54],["Spoto Press","r",.22,.42,.65,.82,.95,1.08,1.22,1.45],["Incline Hammer Press","a",8,16,26,34,40,46,52,62],["Incline Cable Fly","a",4,8,16,22,26,30,36,44],["Incline Chest Dip (reps)","a",1,3,8,14,18,24,32,44],["Low Incline DB Press","a",8,16,26,34,40,46,52,62],["Incline DB Squeeze Press","a",6,14,22,30,36,42,48,58],["Incline Plate Press","a",5,10,18,26,32,38,44,54],["Machine Incline Fly","a",8,16,28,38,44,52,60,72],["Cable Incline Crossover","a",4,8,16,22,26,30,36,44],["Incline Push-up (reps)","a",5,12,25,35,45,55,70,90],["Incline JM Press","r",.18,.32,.50,.65,.75,.85,1.00,1.22],["Incline Band Press","a",6,14,22,30,36,42,48,58],["1-Arm Incline DB Press","a",4,9,15,19,22,26,29,35],["Neutral Grip Incline DB Press","a",8,16,26,34,40,46,52,62]]),
mc:mk([["BB Bench Press","r",.30,.50,.80,1.00,1.15,1.30,1.50,1.80],["DB Bench Press","a",10,20,32,40,48,54,60,72],["Machine Chest Press","a",15,35,55,70,82,92,105,125],["Cable Crossover","a",4,10,18,24,28,34,40,50],["DB Fly","a",5,10,18,24,28,32,36,44],["Pec Deck","a",12,25,45,60,70,80,90,108],["Push-ups (reps)","a",3,10,25,35,45,55,70,90],["Smith Bench","r",.25,.45,.72,.92,1.05,1.18,1.35,1.55],["Floor Press","r",.25,.45,.70,.88,1.00,1.12,1.28,1.50],["Svend Press","a",2,5,10,16,20,24,28,36],["Hex Press","a",8,16,26,34,40,46,52,62],["Cable Chest Press","a",6,14,24,32,38,44,52,62],["Flat Cable Fly","a",4,10,18,24,28,34,40,50],["Resistance Band Press (reps)","a",5,12,22,32,40,48,58,72],["Tempo Bench Press","r",.25,.42,.68,.85,.98,1.10,1.28,1.52],["Pin Press","r",.28,.48,.78,.98,1.12,1.28,1.48,1.75],["Larsen Press","r",.25,.42,.68,.85,.98,1.10,1.28,1.52],["Board Press","r",.30,.52,.82,1.02,1.18,1.32,1.52,1.82],["Dip Machine (reps)","a",3,8,16,24,30,38,48,62],["Band Chest Fly (reps)","a",5,12,22,32,40,48,58,72],["Bamboo Bar Bench","r",.20,.38,.60,.78,.88,1.00,1.18,1.42],["Paused Bench Press","r",.25,.42,.68,.85,.98,1.10,1.28,1.52],["Guillotine Press","r",.25,.42,.68,.85,.98,1.10,1.28,1.53],["Slingshot Bench Press","r",.34,.57,.92,1.15,1.32,1.50,1.72,2.07]]),
...
lb:mk([["Conv Deadlift","r",.45,.75,1.20,1.55,1.75,1.95,2.40,2.90],["Romanian DL","r",.35,.58,.92,1.18,1.35,1.55,1.82,2.15],["Good Morning","r",.15,.35,.58,.75,.85,.95,1.12,1.35],["Hex Bar DL","r",.45,.75,1.20,1.50,1.70,1.88,2.28,2.72],["Sumo DL","r",.45,.75,1.20,1.52,1.72,1.92,2.38,2.85],["Stiff-Leg DL","r",.30,.55,.88,1.12,1.28,1.45,1.70,2.00],["Deficit DL","r",.40,.68,1.10,1.42,1.62,1.82,2.22,2.65],["Block Pull","r",.50,.82,1.30,1.62,1.82,2.02,2.48,2.95],["Back Extension (wt)","a",0,8,18,26,32,38,48,60],["Hyperextension (reps)","a",3,8,15,22,28,34,42,55],["Rev Hyperextension","a",0,8,18,28,34,40,50,62],["Jefferson DL","r",.35,.60,.95,1.22,1.40,1.58,1.85,2.22],["Suitcase DL","a",10,22,36,48,56,64,72,86],["Paused Deadlift","r",.38,.65,1.05,1.35,1.55,1.72,2.10,2.55],["Snatch Grip DL","r",.38,.65,1.05,1.35,1.55,1.72,2.10,2.55],["Banded Deadlift","r",.42,.72,1.15,1.48,1.68,1.88,2.30,2.78],["Rack RDL","r",.38,.62,.98,1.25,1.42,1.62,1.90,2.25],["KB Deadlift","a",8,18,30,40,48,56,64,78],["Single Leg DL","a",4,10,18,26,32,38,44,54],["Duck Walk (reps)","a",3,8,14,22,28,34,42,54],["Hip Hinge (Bodyweight, reps)","a",5,12,22,32,42,52,65,82],["Superman Hold (seconds)","a",10,20,35,50,65,80,100,130],["Sumo DL High Pull","r",.25,.42,.68,.85,.98,1.10,1.32,1.60],["Seated Good Morning","r",.12,.28,.48,.62,.72,.80,.95,1.15]]),
fd:mk([["OHP (Barbell)","r",.20,.35,.55,.70,.80,.92,1.10,1.35],["DB Shoulder Press","a",6,14,24,32,38,44,48,58],["Arnold Press","a",6,12,22,30,36,42,46,56],["Machine Shoulder Press","a",12,25,45,58,68,78,88,105],["Push Press","r",.25,.45,.68,.85,.98,1.12,1.30,1.55],["Seated DB Press","a",6,14,24,32,38,44,48,58],["Smith OHP","r",.18,.32,.50,.65,.75,.85,1.00,1.22],["Plate Front Raise","a",5,10,16,22,26,30,36,44],["DB Front Raise","a",3,7,12,18,22,26,30,38],["Cable Front Raise","a",3,7,12,18,22,26,30,38],["BB Front Raise","a",4,10,18,24,28,34,40,50],["Z Press","r",.15,.28,.45,.58,.68,.78,.92,1.12],["Seated BB OHP","r",.18,.32,.52,.68,.78,.90,1.05,1.28],["Klokov Press","r",.12,.22,.38,.50,.58,.68,.80,.98],["Landmine Shoulder Press","a",6,14,24,32,38,44,52,62],["Behind Neck Press","r",.15,.28,.45,.58,.68,.78,.92,1.12],["Handstand Push-ups (reps)","a",0,1,4,8,12,16,22,30],["Bottoms Up KB Press","a",4,8,14,20,26,32,38,48],["Single Arm DB Press","a",4,10,18,26,32,38,44,54],["Band OHP (reps)","a",5,12,22,32,40,48,58,72],["Javelin Press","a",4,10,18,26,32,38,44,54],["Savickas Press","r",.15,.28,.45,.58,.68,.78,.92,1.12],["Bradford Press","r",.16,.28,.46,.58,.67,.77,.92,1.12],["Cuban Press","a",2,5,9,13,16,19,23,29]]),
sd:mk([["DB Lateral Raise","a",2,6,10,14,17,20,24,32],["Cable Lateral Raise","a",2,6,10,14,17,20,24,32],["Machine Lateral Raise","a",6,15,28,38,44,52,60,72],["Leaning Lateral Raise","a",2,5,10,14,17,20,24,30],["Behind-Back Cable Lat","a",2,5,10,14,17,20,24,30],["Upright Row (Wide)","r",.12,.25,.40,.52,.60,.68,.80,.98],["Lu Raise","a",2,4,8,12,15,18,22,28],["Cross-Body Cable Raise","a",2,5,10,14,17,20,24,30],["Incline Lateral Raise","a",2,4,8,12,15,18,22,28],["Bus Driver","a",5,10,16,22,26,30,36,44],["Egyptian Lateral Raise","a",2,5,10,14,17,20,24,30],["W Lateral Raise","a",1,4,8,12,15,18,22,28],["Chest Supported Lateral","a",2,5,10,14,17,20,24,30],["Banded Lateral Raise","a",2,5,10,14,17,20,24,30],["Partial Lateral Raise","a",3,8,14,20,24,28,34,42],["DB Y Press","a",3,7,12,18,22,26,30,38],["Seated Lateral Raise","a",2,5,10,14,17,20,24,30],["Plate Lateral Raise","a",3,7,12,18,22,26,30,38],["Half Kneeling Lateral","a",2,4,8,12,15,18,22,28],["Prone Lateral Raise","a",1,4,8,12,15,18,22,28],["Cable Y-Raise","a",2,5,8,12,15,17,21,27],["Cheat Lateral Raise","a",3,8,14,20,24,28,34,45]]),
rd:mk([["Reverse Fly (DB)","a",2,6,10,14,17,20,24,32],["Face Pull (Rear)","a",4,8,16,22,26,32,38,48],["Reverse Fly Machine","a",8,18,32,42,50,58,66,80],["Cable Reverse Fly","a",2,6,10,14,17,20,24,32],["Band Pull-Apart (reps)","a",5,10,18,26,32,38,46,60],["Prone Y Raise","a",1,3,7,11,14,17,20,26],["Seated Rear Fly","a",2,6,10,14,17,20,24,32],["W Raise","a",1,3,7,11,14,17,20,26],["Incline Rear Fly","a",2,5,10,14,17,20,24,30],["Standing Cable Rear Fly","a",2,5,10,14,17,20,24,30],["Rev Pec Deck (Wide)","a",6,14,26,36,44,52,60,72],["Banded Face Pull (reps)","a",8,16,26,36,44,52,62,78],["Chest Supported Rear Fly","a",2,5,10,14,17,20,24,30],["Prone I Raise","a",1,3,6,10,13,16,20,26],["TRX Rear Fly (reps)","a",3,7,14,20,24,28,34,42],["DB Powell Raise","a",1,3,7,11,14,17,20,26],["Rear Delt Row","a",3,7,14,20,24,28,34,42],["Scarecrow","a",1,4,7,10,13,15,18,24],["Cross-Arm Cable Reverse Fly","a",2,5,9,13,16,19,23,30],["Wall Slide (reps)","a",5,10,18,26,32,38,46,60]]),
...
// New exercises added to fill gaps left by deduping near-identical entries
FG["1-Arm Incline DB Press"]=["DB in one hand, incline bench","Press up, other hand braced","Core resists rotation","Switch sides"];
FG["Neutral Grip Incline DB Press"]=["Palms facing each other, incline","Press straight up","Easier on shoulders","Lower under control"];
FG["Guillotine Press"]=["Flat bench, wide grip","Lower bar to neck/upper chest","Light weight, spotter recommended","Press to lockout"];
FG["Slingshot Bench Press"]=["Slingshot device around arms","Assists out of the bottom","Overload the lockout","Lets you handle more weight safely"];
FG["Kneeling Lat Pulldown"]=["Kneel below the cable stack","Pull bar to upper chest","Removes leg drive/counterbalance","Squeeze lats at bottom"];
FG["Gironda Chin-up (reps)"]=["Very wide, palms-in grip","Lean back, pull chest to bar","Touch upper chest/sternum","Named after Vince Gironda"];
FG["Sumo DL High Pull"]=["Sumo stance, explosive pull","Pull bar up to chest height","Elbows drive high and wide","Lighter than a full sumo pull"];
FG["Seated Good Morning"]=["Seated, bar on back","Hinge forward at hips","No leg drive to assist","Sit back up, squeeze glutes"];
FG["Bradford Press"]=["Bar overhead, no lockout","Lower behind head slightly, then front","Continuous motion, light weight","Builds shoulder endurance"];
FG["Cuban Press"]=["Upright row to elbow height","Rotate into external rotation","Press overhead from there","Light weight, technical"];
FG["Cable Y-Raise"]=["Low cable, arms form a Y","Raise up and out at an angle","Between front and lateral raise","Squeeze at top"];
FG["Cheat Lateral Raise"]=["Slight body English to start the raise","Control the lowering strictly","Lets you overload beyond strict form","Use sparingly"];
FG["Scarecrow"]=["Elbows at shoulder height, bent 90°","Rotate forearms up like a goalpost","Slow and controlled","Great rear delt/rotator cuff activation"];
FG["Cross-Arm Cable Reverse Fly"]=["Cross cables in front before gripping","Pull apart to sides","Different angle than standard reverse fly","Squeeze rear delts"];
FG["Wall Slide (reps)"]=["Back and arms against wall","Slide arms up into a Y","Keep contact with the wall","Great for posture and scapular control"];
FG["Weighted Nordic Curl"]=["Ankles secured, hold weight to chest","Lower forward as slowly as possible","Extra load past bodyweight Nordics","Push back up or catch yourself"];
FG["Single Leg Hamstring Bridge (reps)"]=["On back, one heel on floor/bench","Drive hips up on that leg","Squeeze hamstring and glute","Switch sides"];
FG["Fat Bar Curl"]=["Thick bar or fat grips attached","Curl as normal, harder grip demand","Expect to use less weight","Builds grip and forearm size too"];
FG["Behind the Back Cable Curl"]=["Face away from low cable","Curl hand back and up","Unique constant-tension angle","Switch sides"];
FG["Rolling DB Tricep Ext"]=["Lying flat, DB starts at hips","Roll DB back overhead as you extend","Continuous rolling motion","Constant tension on triceps"];
FG["Tricep Cable Kickback"]=["Cable at low pulley, hinge forward","Extend arm back, squeeze tricep","Keep upper arm still","Switch sides"];
FG["Behind the Back Wrist Curl"]=["Bar behind back, palms back","Curl wrists up","Unusual but effective angle","Light weight"];
FG["Radial Deviation Curl"]=["Hold a hammer or weighted stick by the end","Move wrist side to side","Isolates radial/ulnar deviation","Very light weight, high control"];
FG["B-Stance Hip Thrust"]=["Bar over hips, one foot slightly forward","Most of the load on the rear leg","Semi-unilateral, easier to balance than single-leg","Switch sides"];
FG["Sumo Squat (Glute)"]=["Wide stance, toes out","Squat down, knees track over toes","Extra glute/adductor emphasis","Drive up through heels"];
FG["Cable Reverse Crunch (reps)"]=["Ankle strap on low cable, lie back","Curl knees toward chest against resistance","Constant tension throughout","Slow and controlled"];
FG["Weighted Plank (seconds)"]=["Standard plank position","Plate or weight placed on back","Core works harder to stabilize","Have a partner load/unload safely"];
FG["Landmine 180 (reps)"]=["Hold landmine end at arm's length","Rotate bar from side to side, floor to floor","Full-body rotational power","Control the deceleration each side"];
FG["Kneeling Cable Twist"]=["Kneel side-on to cable, half-kneeling","Rotate torso against resistance","Hips stay square, isolates obliques","Switch sides"];
